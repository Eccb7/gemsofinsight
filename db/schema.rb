...
ActiveRecord::Schema[7.2].define(version: 2024_08_20_173439) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["blog_category_id"], name: "index_articles_on_blog_category_id"
  end
  ...
  add_foreign_key "articles", "blog_categories"
